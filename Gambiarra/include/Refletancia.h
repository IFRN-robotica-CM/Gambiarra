...
class Refletancia {
  ...
  private:
    #define DIVISOR_BRANCO_PRETO_MAIS_ESQ 40
    #define DIVISOR_BRANCO_PRETO_ESQ 50
    #define DIVISOR_BRANCO_PRETO_DIR 55
  ...
  public:
    ...
    inline bool esquerda(){return (pppb() || pbbb() || bpbb() || ppbb());}
    inline bool  direita(){return (bppp() || bbpb() || bbbp() || bbpp());}
